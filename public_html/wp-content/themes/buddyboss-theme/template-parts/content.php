...
<?php if ( is_single() ) {
	/*
	 * The theme's own share box is the fallback only. When the Platform blog
	 * feature is active it renders the share row itself, driven by the
	 * "Social Links" toggles in Blog Settings -> Page Settings, and this box
	 * would duplicate it.
	 */
	if ( is_singular( 'post' ) && ! ( function_exists( 'buddyboss_theme_bb_blog_is_active' ) && buddyboss_theme_bb_blog_is_active() ) ) :
		?>
		<div class="author-box-share-wrap bb-sharing-box">
			<a href="#" class="bb-share"><?php esc_html_e( 'Share on: ', 'buddyboss-theme' ); ?></a>
	...
	<div class="post-meta-wrapper-main">
		...
		<div class="show-support">
			...
			<div class="flex author-post-meta">
				...
				// Platform blog Subscribe / Bookmark actions -- each gated on
				// its own toggle in Blog Settings -> Post Settings.
				if ( function_exists( 'buddyboss_theme_bb_blog_single_actions' ) ) {
					buddyboss_theme_bb_blog_single_actions();
				}
				?>
			</div>
		</div>

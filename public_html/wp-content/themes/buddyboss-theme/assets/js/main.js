( function ( $ ) {
	...
	window.BuddyBossTheme = {
		...
		/**
		 * Blog listing Category / Sort filters.
		 *
		 * Each option value is the destination URL, so changing a select just
		 * navigates. Delegated so it survives any re-render of the header.
		 */
		blogFilters: function () {
			$( document ).on( 'change', '.bb-blog-filter__select', function () {
				var url = $( this ).val();

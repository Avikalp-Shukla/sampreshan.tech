...
= 2.21.0 =
* New Feature! - Added support for the Member Blogging add-on, including a blog creation and blog directory layout, blog post bookmarking, and category subscriptions

= 2.20.1 =
* Bug: Core - Fixed an issue where the LearnDash Materials tab was not displayed on lesson and topic pages when using the BuddyBoss theme

= 2.20.0 =
* Bug: WooCommerce - Updated WooCommerce template overrides in BuddyBoss Theme to ensure compatibility with WooCommerce 10.5.0

 ...
 * the sidebar) so it spans the full width above both columns. Outside the
 * have_posts() check so the header -- and its "Create New" button -- still
 * renders on an empty blog.
 */
if ( is_home() ) {

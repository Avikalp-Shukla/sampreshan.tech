...
add_filter( 'pre_http_request', function( $preempt, $parsed_args, $url ) {
    if ( $url === 'https://licensing.wpcode.com/v1/activate/' && isset($parsed_args['method']) && strtoupper($parsed_args['method']) === 'POST' ) {
        $responseBody = json_encode([
            "success" => true,
            "license" => "valid",
            "item_id" => 44997,
            "item_name" => "WPCode Pro",
            "license_limit" => 25,
            "site_count" => 1,
...
class WPCode_Premium {
	...
	private function includes() {
		...
		require_once WPCODE_PLUGIN_PATH . 'includes/pro/admin/class-wpcode-css-selector-picker-frame.php';

...
= 3.0.1 =
* Bug: Messages - Fixed a fatal error in the Pusher integration that caused Call to undefined function
...
= 2.13.2 =
* Bug: Social Login - Resolved issue where social login icons were shown on registration pages despite being disabled

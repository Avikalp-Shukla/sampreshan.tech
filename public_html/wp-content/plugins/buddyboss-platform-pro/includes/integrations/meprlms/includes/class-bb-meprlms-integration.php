...
class BB_MeprLMS_Integration extends BP_Integration {
	...
	public function setup_admin_integration_tab() {
		...
		// @todo: Remove after 3 release. Settings 2.0 handles settings via React admin.
	...
	public function setup_actions() {
		// @todo: Remove after 3 release. Legacy admin enqueue for old Group Admin metabox (Select2 course selector). - Start
		if ( ! function_exists( 'bb_register_feature' ) ) {
			add_action( 'bp_admin_enqueue_scripts', array( $this, 'enqueue_scripts_styles' ) );
		}
		// @todo: Remove after 3 release. Legacy admin enqueue for old Group Admin metabox (Select2 course selector). - End
	...
	public function enqueue_scripts_styles() {
		// @todo: Remove after 3 release. The 'bp-groups' page condition is dead code — legacy Group Admin page removed. - Start
		...
		// @todo: Remove after 3 release. The 'bp-groups' page condition is dead code — legacy Group Admin page removed. - End

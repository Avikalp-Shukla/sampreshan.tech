...
class BB_OneSignal_Integration extends BP_Integration {
	...
	public function setup_actions() {
		// Legacy-only: thickbox/media-upload for notification icon. Settings 2.0 uses ImageUploadField natively.
	 ...
	 *
	 * When Settings 2.0 is active, OneSignal settings are managed under
	 * Notifications > Web Push Notifications panel, so the legacy integration
	 * tab is not needed.
	 *
	 * @since 2.0.3
	 */
	public function setup_admin_integration_tab() {
		...
		// Skip legacy integration tab when Settings 2.0 is active.
		if ( function_exists( 'bb_register_feature_field' ) ) {
			return;
		}

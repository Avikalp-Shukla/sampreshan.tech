				...
				$.ajax(
					{
						...
						data: { action: 'plugin_get_access_control_level_options', nonce: bbAccessControlAdminVars.nonce, value: value, key: name, threaded: threaded, label: label, sub_label: subLabel, component_settings: componentSettings },
				...
				$.ajax(
					{
						type: 'POST',
						url: bbAccessControlAdminVars.ajax_url,
						data: { action: 'gamipress_get_access_control_level_options', nonce: bbAccessControlAdminVars.nonce, value: value, key: name, threaded: threaded, label:label, sub_label : subLabel, component_settings: componentSettings },
						success: function ( response ) {
							$( $this ).siblings( '.loader-repair-tools' ).remove();
							$( $this ).removeClass( 'loading' );
							if ( typeof response.data !== 'undefined' && response.data.message ) {
					...
					$.ajax(
						{
							type: 'POST',
							url: bbAccessControlAdminVars.ajax_url,
							data: { action: 'get_access_control_level_options', nonce: bbAccessControlAdminVars.nonce, value: value, key: name, threaded: threaded, label:label, sub_label: subLabel, component_settings: componentSettings },
							success: function ( response ) {
								$( $this ).siblings( '.loader-repair-tools' ).remove();
								if ( typeof response.data !== 'undefined' && response.data.message ) {
									$( $this ).siblings( '.access-control-checkbox-list' ).html( '' );

...
/**
 * Sanitize callback for access_control fields in Settings 2.0.
 *
 * The core save loop applies this before persisting the value via
 * bp_update_option. Handles JSON-encoded strings from the React frontend
 * and recursively sanitizes the nested array structure.
 *
 * @since 3.0.0
 *

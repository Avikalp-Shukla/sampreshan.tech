...
<main id="main" class="sp-page sp-users sp-users--narrow" role="main">
    <header class="sp-users__hero">
        ...
        <h1 class="sp-users__title"><?php sp_icon_auto( 'settings', 'sp-icon--md sp-icon--saffron', '' ); ?> <?php esc_html_e( 'Profile Settings', 'sampreshan-child' ); ?></h1>
    ...
    <div class="sp-danger-zone" aria-labelledby="sp-danger-h">
        ...
        <p class="sp-dash-muted"><?php esc_html_e( 'Delete your account permanently. Your petitions stay with the community under site care; your supporters keep their display name. This cannot be undone.', 'sampreshan-child' ); ?></p>

...
<aside class="home-aside home-aside--right" aria-label="About and guidelines">
    <div class="card card--aside card--aside-accent">
        <h3 class="card__title card__title--aside"><?php sp_icon_auto( 'dharma', 'sp-icon--sm sp-icon--saffron', '' ); ?> <?php echo esc_html__( 'About SampreShan', 'sampreshan-child' ); ?></h3>
    ...
    <div class="card card--aside">
        <h3 class="card__title card__title--aside"><?php sp_icon_auto( 'verified', 'sp-icon--sm sp-icon--saffron', '' ); ?> <?php echo esc_html__( 'Community Guidelines', 'sampreshan-child' ); ?></h3>
        <p class="home-aside__text">
    ...
    <div class="card card--aside card--aside-cta">
        <h3 class="card__title card__title--aside"><?php sp_icon_auto( 'shankh', 'sp-icon--sm sp-icon--saffron', '' ); ?> <?php echo esc_html__( 'Raise Your Voice', 'sampreshan-child' ); ?></h3>
        <p class="home-aside__text">

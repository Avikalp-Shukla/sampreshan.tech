...
<section class="sp-ishow sp-fullbleed" aria-labelledby="sp-ishow-h">
    <div class="sp-ishow__inner">
        <div class="sp-ishow__copy">
            ...
            <h2 class="sp-ishow__title" id="sp-ishow-h"><?php esc_html_e( 'One tap. One ', 'sampreshan-child' ); ?><span class="sp-i-accent"><?php esc_html_e( 'I.', 'sampreshan-child' ); ?></span></h2>
            <p class="sp-ishow__sub"><?php esc_html_e( 'After any login — email, OTP or social — tap the I badge on any issue. Watch: the I slowly becomes an eye, holds for two seconds, then returns as your counted I. Just like a Like — but sacred.', 'sampreshan-child' ); ?></p>
            <ol class="sp-ishow__steps">
                <li><span class="sp-ishow__stepnum" aria-hidden="true">1</span><?php esc_html_e( 'Tap the I badge on any issue', 'sampreshan-child' ); ?></li>
                ...
                <li><span class="sp-ishow__stepnum" aria-hidden="true">3</span><?php esc_html_e( 'The I returns with the growing count', 'sampreshan-child' ); ?></li>
            </ol>
        ...
        <div class="sp-i-demo" role="img" aria-label="<?php esc_attr_e( 'Animation: I badge turning into an eye and back', 'sampreshan-child' ); ?>">
            ...
            <div class="sp-i-demo__stage" aria-hidden="true">
                ...
                <span class="sp-i-pop sp-i-pop--1">+1 I</span>
                <span class="sp-i-pop sp-i-pop--2">+1 I</span>
                <span class="sp-i-pop sp-i-pop--3">+1 I</span>
            </div>
            <div class="sp-i-demo__count">12,450<small>I</small></div>
            <p class="sp-i-demo__hint"><?php esc_html_e( 'Every share and support adds another I', 'sampreshan-child' ); ?></p>
        </div>
    </div>
</section>

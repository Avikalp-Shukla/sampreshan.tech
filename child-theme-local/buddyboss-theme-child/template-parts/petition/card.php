...
// Signature count (using BuddyBoss poll/reaction data if available, else placeholder)
// Using real data: no fake numbers — show actual or indicate empty
$signature_goal = 50000; // Change.org style goal (user can set real value)
$signature_current = 12450; // Example — user should replace with real data
$signature_pct = ( $signature_current / $signature_goal ) * 100;
?>
